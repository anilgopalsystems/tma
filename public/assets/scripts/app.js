...
var App = function () {
    ...
    var customfunctionality = function(){
            //var livalue = $(this).attr('value');
            $('ul.page-sidebar-menu li.menuclass').each(function(){
                if($(this).attr('menuvalue')==$('div.menuvalue').text()){
                    $(this).addClass('active');
                }
                console.log($('div.menuvalue').text()+' '+$(this).attr('menuvalue'));
            });
            //
    }
