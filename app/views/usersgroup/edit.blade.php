		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					{{ ucfirst($common_name) }} <small>edit {{ $common_name }}</small>
					</h3>
				...
				<div class="col-md-12">
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										{{ Form::model($data, array('route' => array(''.$common_name.'.update', $data->id), 'method' => 'PUT', 'class'=>'form-horizontal', 'id'=>'assetgroupform')) }}
...
<?php 
$assets = json_decode($data->assets); 
$assetgroups = json_decode($data->assetgroups); 
$users = json_decode($data->users); 
$usersgroup = json_decode($data->usersgroup);
...
@section('pageplugins')
	...
	jQuery(document).ready(function() {       
	   ...
	   // assets menu
	   if({{ $assets->all }}){
	   		$('.assets').bootstrapSwitch('setState', true);
	   		$(".assetscheckboxes input#add").prop('checked',{{ $assets->add }});
	   		$(".assetscheckboxes input#edit").prop('checked',{{ $assets->edit }});
	   		$(".assetscheckboxes input#delete").prop('checked',{{ $assets->delete }});	   		
	   }else{
	   		$('.assets').bootstrapSwitch('setState', false);
	   ...
	   // asset groups menu
	   if({{ $assetgroups->all }}){
	   		$('.assetgroups').bootstrapSwitch('setState', true);
	   		$(".assetgroupscheckboxes input#add").prop('checked',{{ $assetgroups->add }});
	   		$(".assetgroupscheckboxes input#edit").prop('checked',{{ $assetgroups->edit }});
	   		$(".assetgroupscheckboxes input#delete").prop('checked',{{ $assetgroups->delete }});	   		
	   }else{
	   		$('.assetgroups').bootstrapSwitch('setState', false);
	   ...
	   // users menu
	   if({{ $users->all }}){
	   		$('.users').bootstrapSwitch('setState', true);
	   		$(".userscheckboxes input#add").prop('checked',{{ $users->add }});
	   		$(".userscheckboxes input#edit").prop('checked',{{ $users->edit }});
	   		$(".userscheckboxes input#delete").prop('checked',{{ $users->delete }});	   		
	   }else{
	   		$('.users').bootstrapSwitch('setState', false);
	   ...
	   // usersgroup menu
	   if({{ $usersgroup->all }}){
	   		$('.usersgroup').bootstrapSwitch('setState', true);
	   		$(".usersgroupcheckboxes input#add").prop('checked',{{ $usersgroup->add }});
	   		$(".usersgroupcheckboxes input#edit").prop('checked',{{ $usersgroup->edit }});
	   		$(".usersgroupcheckboxes input#delete").prop('checked',{{ $usersgroup->delete }});	   		
	   }else{
	   		$('.usersgroup').bootstrapSwitch('setState', false);
	   ...
	   // locations menu
	   if({{ $locations->all }}){
	   		$('.locations').bootstrapSwitch('setState', true);
	   		$(".locationscheckboxes input#add").prop('checked',{{ $locations->add }});
	   		$(".locationscheckboxes input#edit").prop('checked',{{ $locations->edit }});
	   		$(".locationscheckboxes input#delete").prop('checked',{{ $locations->delete }});	   		
	   }else{
	   		$('.locations').bootstrapSwitch('setState', false);
	   ...
	   // stores menu
	   if({{ $stores->all }}){
	   		$('.stores').bootstrapSwitch('setState', true);
	   		$(".storescheckboxes input#add").prop('checked',{{ $stores->add }});
	   		$(".storescheckboxes input#edit").prop('checked',{{ $stores->edit }});
	   		$(".storescheckboxes input#delete").prop('checked',{{ $stores->delete }});	   		
	   }else{
	   		$('.stores').bootstrapSwitch('setState', false);
