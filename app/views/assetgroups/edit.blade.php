				...
				<div class="col-md-12">
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										{{ Form::model($data, array('route' => array(''.$common_name.'.update', $data->id), 'method' => 'PUT', 'class'=>'form-horizontal')) }}
										<!-- <form action="#" class="form-horizontal"> -->
											<div class="form-body">
												<div class="btn-group pull-right">
													<button type="button" onclick="addextrafeild()" class="btn green">Create Additional Feilds <i class="fa fa-plus"></i></button>
												</div>
												<h3 style="margin-top: 5px;" class="form-section">{{ ucfirst($common_name) }} Info</h3>
												<div class="row  addfeild">
													<div class="col-md-6">
													...
													<?php
														//if($data->udf1!=''){
															...
															for ($i=1; $i <=20 ; $i++) {
																$temp = 'udf'.$i;
																if($data->$temp!=null){
																	echo '<div class="col-md-6"><div class="form-group"><label class="control-label col-md-3">Feild Name '.$i.'</label><div class="col-md-9"><div class="input-group"><input style="border:1px solid #88B2F5" class="form-control" name="udf[]" type="text" value="'.$data->$temp.'"><span style="cursor:pointer" onclick="deleteextrafeild(this)" class="input-group-addon"><i style="color:rgb(248, 82, 82);font-size:20px" class="fa fa-minus-circle"></i></span></div></div></div></div>';
																	$itemp++;
																}
															}
														//}
...
@section('pageplugins')
	...
	function addextrafeild(){
		$('.addfeild').append('<div class="col-md-6"><div class="form-group"><label class="control-label col-md-3">Feild Name '+feildcount+'</label><div class="col-md-9"><div class="input-group"><input style="border:1px solid #88B2F5" class="form-control" name="udf[]" type="text" value=""><span style="cursor:pointer" onclick="deleteextrafeild(this)" class="input-group-addon"><i style="color:rgb(248, 82, 82);font-size:20px" class="fa fa-minus-circle"></i></span></div></div></div></div>');
		feildcount++;
	}
	function deleteextrafeild(obj){
