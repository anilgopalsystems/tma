				...
				<div class="col-md-12">
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										{{ Form::open(array('route' => array('users.update', $usersdata->id), 'method' => 'PUT', 'class'=>'form-horizontal')) }}
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('firstname', $usersdata->firstname,array('class' => 'form-control','required'=>'required')) }}
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('lastname', $usersdata->lastname,array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
													<!--/span-->
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" id='dob'>
																	{{ Form::text('dob', '', array('class' => 'form-control','readonly'=>'readonly')) }}
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('email', $usersdata->email,array('class' => 'form-control','required'=>'required')) }}
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('mobile',$usersdata->mobile,array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('address1',$usersdata->address1,array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('address2',$usersdata->address2,array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('city',$usersdata->city,array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('pincode',$usersdata->pincode,array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('state',$usersdata->state,array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('pan',$usersdata->pan,array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('fathersname',$usersdata->fathersname,array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('aadhaar',$usersdata->aadhaar,array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" id='hiredate'>
																	{{ Form::text('hiredate', '', array('class' => 'form-control','readonly'=>'readonly')) }}
																	<span class="input-group-btn">
																		<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
																	</span>
																</div>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('position',$usersdata->position,array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
													<!--/span-->
...
<?php
	if(isset($usersdata->dob)){
	$dob = DateTime::createFromFormat('Y-m-d', $usersdata->dob)->format('d-m-Y');
	}

	if(isset($usersdata->hiredate)){
	$hiredate = DateTime::createFromFormat('Y-m-d', $usersdata->hiredate)->format('d-m-Y');
	}
...
@section('pageplugins')
	...
	jQuery(document).ready(function() {       
	   ...
	   $("#dob").datepicker("update",'{{ $dob or '' }}');
	   $("#hiredate").datepicker("update",'{{ $hiredate or '' }}');

	   $("select[name='type']").select2("val", {{ $usersdata->type }});
	   $("select[name='report_to']").select2("val", {{ $usersdata->report_to }});
