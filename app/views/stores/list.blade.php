				...
				<div class="col-sm-12">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							<?php if(json_decode(Session::get('usergroupdata')->stores)->add=='true'){ ?>
							...
							<tr class="odd gradeX">
								...
								<td align="center">
									...
									<?php if(json_decode(Session::get('usergroupdata')->stores)->edit=='true'){ ?>
									<a href="{{ URL::route(''.$common_name.'.edit', $value->id) }}"><i class="fa fa-pencil"></i></a> | 
									<?php } ?>

									<?php if(json_decode(Session::get('usergroupdata')->stores)->delete=='true'){ ?>
