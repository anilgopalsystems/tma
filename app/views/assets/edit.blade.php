...
@section('content')
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					{{ Form::model($assetdata, array('route' => array('myassets.update', $assetdata->id), 'method' => 'PUT', 'class'=>'form-horizontal')) }}
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('asset_name', $assetdata->asset_name, array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::select('category', $assetgrouplist , $assetdata->category,array('class'=>'form-control input-medium select2me','data-placeholder'=>'Select...')) }}
															</div>
														</div>
													</div>
													<!--/span-->
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('description', $assetdata->description, array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::select('assign_to', $userslist , $assetdata->assign_to,array('class'=>'form-control input-medium select2me','data-placeholder'=>'Select...')) }}
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('quantity', $assetdata->quantity, array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::select('location', $locationlist , $assetdata->location,array('class'=>'form-control input-medium select2me','data-placeholder'=>'Select...')) }}
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('modelnumber', $assetdata->modelnumber, array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
													<!--/span-->
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('asset_serial', $assetdata->asset_serial, array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('asset_value', $assetdata->asset_value, array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('manufacturer', $assetdata->manufacturer, array('class' => 'form-control')) }}
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																{{ Form::text('asset_key', $assetdata->asset_key, array('class' => 'form-control','readonly'=>'readonly')) }}
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
														...
														<div class="form-group">
															...
															<div class="col-md-3">
																<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" id='purchased_on'>
																	...
																	{{ Form::text('purchased_on', '', array('class' => 'form-control','readonly'=>'readonly')) }}
													...
													<!-- <div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Asset key</label>
															<div class="col-md-9">
																{{ Form::text('asset_key', $assetdata->asset_key, array('class' => 'form-control')) }}
															</div>
														</div>
													</div> -->
												</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" name="warranty_service_provider" value="{{ $warrantydata->warranty_service_provider or '' }}" class="form-control">
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Description</label>
															<div class="col-md-9">
																<input type="text" name="warranty_description" value="{{ $warrantydata->warranty_description or '' }}" class="form-control">
															</div>
														</div>
													</div>
													<!--/span-->
														...
														<div class="form-group">
															...
															<div class="col-md-9">																
																<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" id='warranty_start_date'>
																	<!-- <input type="text" class="form-control" readonly> -->
																	{{ Form::text('warranty_start_date', '', array('class' => 'form-control','readonly'=>'readonly')) }}
																	<span class="input-group-btn">
																		<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
																	</span>
																</div>
														...
														<div class="form-group">
															...
															<div class="col-md-9">																																
																<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" id='warranty_end_date'>
																	<!-- <input type="text" class="form-control" readonly> -->
																	{{ Form::text('warranty_end_date', '', array('class' => 'form-control','readonly'=>'readonly')) }}
																	<span class="input-group-btn">
																		<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
																	</span>
																</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Service Provider</label>
															<div class="col-md-9">
																<input type="text" name="insurance_service_provider" value="{{ $insurancedata->insurance_service_provider or '' }}" class="form-control">
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Description</label>
															<div class="col-md-9">
																<input type="text" name="insurance_description" value="{{ $insurancedata->insurance_description or '' }}" class="form-control">
															</div>
														</div>
													</div>
													<!--/span-->
														...
														<div class="form-group">
															...
															<div class="col-md-9">																
																<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" id='insurance_start_date'>
																	<!-- <input type="text" class="form-control" readonly> -->
																	{{ Form::text('insurance_start_date', '', array('class' => 'form-control','readonly'=>'readonly')) }}
																	<span class="input-group-btn">
																		<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
																	</span>
																</div>
														...
														<div class="form-group">
															...
															<div class="col-md-9">																																
																<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" id='insurance_end_date'>
																	<!-- <input type="text" class="form-control" readonly> -->
																	{{ Form::text('insurance_end_date', '', array('class' => 'form-control','readonly'=>'readonly')) }}
																	<span class="input-group-btn">
																		<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
																	</span>
																</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Service Provider</label>
															<div class="col-md-9">
																<input type="text" name="sla_service_provider" value="{{ $sladata->sla_service_provider or '' }}" class="form-control">
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Description</label>
															<div class="col-md-9">
																<input type="text" name="sla_description" value="{{ $sladata->sla_description or '' }}" class="form-control">
															</div>
														</div>
													</div>
													<!--/span-->
														...
														<div class="form-group">
															...
															<div class="col-md-9">																
																<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" id='sla_start_date'>
																	<!-- <input type="text" class="form-control" readonly> -->
																	{{ Form::text('sla_start_date', '', array('class' => 'form-control','readonly'=>'readonly')) }}
																	<span class="input-group-btn">
																		<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
																	</span>
																</div>
														...
														<div class="form-group">
															...
															<div class="col-md-9">																																
																<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" id='sla_end_date'>
																	<!-- <input type="text" class="form-control" readonly> -->
																	{{ Form::text('sla_end_date', '', array('class' => 'form-control','readonly'=>'readonly')) }}
																	<span class="input-group-btn">
																		<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
																	</span>
																</div>
					...
					<div class="portlet box yellow">
						...
						<div class="portlet-body">
							<div class="table-responsive">
								...
								<?php foreach ($subassetdata as $key => $value) { ?>								
								<tr>
									<td>
										<input type="text" name="sub_asset_name[]" value="{{ $value->asset_name or '' }}" class="form-control">
										<input type="hidden" name="sub_asset_id[]" value="{{ $value->id or '' }}" class="form-control">
									</td>
									<td>
										<input type="text" name="sub_description[]" value="{{ $value->description or '' }}" class="form-control">
									</td>
									<td>
										<input type="text" name="sub_asset_serial[]" value="{{ $value->asset_serial or '' }}" class="form-control">
									</td>
									<td>
										<input type="text" name="sub_manufacturer[]" value="{{ $value->manufacturer or '' }}" class="form-control">
									</td>
									<td>
										<input type="text" name="sub_asset_key[]" value="{{ $value->asset_key or '' }}" class="form-control sub_asset_key">
									</td>
									<td>
										<input type="text" name="sub_quantity[]" value="{{ $value->quantity or '' }}" class="form-control">
									</td>
									<td>
...
<?php
	if(isset($assetdata->purchased_on)){
	$purchased_on = DateTime::createFromFormat('Y-m-d', $assetdata->purchased_on)->format('d-m-Y');
	}

	if(isset($warrantydata->warranty_start_date)){
	$warranty_start_date = DateTime::createFromFormat('Y-m-d', $warrantydata->warranty_start_date)->format('d-m-Y');
	$warranty_end_date = DateTime::createFromFormat('Y-m-d', $warrantydata->warranty_end_date)->format('d-m-Y');
	}

	if(isset($insurancedata->insurance_start_date)){
	$insurance_start_date = DateTime::createFromFormat('Y-m-d', $insurancedata->insurance_start_date)->format('d-m-Y');
	$insurance_end_date = DateTime::createFromFormat('Y-m-d', $insurancedata->insurance_end_date)->format('d-m-Y');
	}

	if(isset($sladata->sla_start_date)){
	$sla_start_date = DateTime::createFromFormat('Y-m-d', $sladata->sla_start_date)->format('d-m-Y');
	$sla_end_date = DateTime::createFromFormat('Y-m-d', $sladata->sla_end_date)->format('d-m-Y');
	}
?>
...
@section('pageplugins')
	...
	jQuery(document).ready(function() {       
	   ...
	   FormSamples.init();
	   FormComponents.init();
	   $("#purchased_on").datepicker("update",'{{ $purchased_on or '' }}');
	   $("#warranty_start_date").datepicker("update",'{{ $warranty_start_date or '' }}');
	   $("#warranty_end_date").datepicker("update",'{{ $warranty_end_date or '' }}');
	   $("#insurance_start_date").datepicker("update",'{{ $insurance_start_date or '' }}');
	   $("#insurance_end_date").datepicker("update",'{{ $insurance_end_date or '' }}');
	   $("#sla_start_date").datepicker("update",'{{ $sla_start_date or '' }}');
	   $("#sla_end_date").datepicker("update",'{{ $sla_end_date or '' }}');
		...
		$('.warrantyonoff').bootstrapSwitch('setState', {{ $assetdata->iswarranty }});
		$('.insuranceoff').bootstrapSwitch('setState', {{ $assetdata->isinsurance }});
		$('.slaonoff').bootstrapSwitch('setState', {{ $assetdata->issla }});
      	...
      	$(".extrafeilds").slideUp( "slow" );
			  ...
			  .done(function( msg ) {			  	
			  	...
			  	if(temp['udf1']!=null){
      				...
      				$.ajax({
			  				type: "POST",
			  				url: "{{ URL::action('AssetsController@udfvalues') }}",
			  				data: {assetid:"{{ $assetdata->id }}",assetgroupid:$("select[name='category']").select2("val") },
         				}).done(function(msg){
							tempdata = JSON.parse(msg);						
			  		for (var i = 1; i <= 20; i++) {
			  			if(temp['udf'+i]!=null&&temp['udf'+i]!=''){
			  				if(tempdata!=null){feildvalue = tempdata['udf'+i]}else{feildvalue = ''}
			  				tempdom = tempdom+'<div class="col-md-6"><div class="form-group"><label class="control-label col-md-3">'+temp['udf'+i]+'</label><div class="col-md-9"><input value="'+feildvalue+'" type="text" name="udfvalue[]" class="form-control"></div></div></div>';
												}
			  		}
      	...
      	$.ajax({
			...
			$.ajax({
			  ...
			  .done(function( msg ) {	
			  	...
			  	$("select[name='store_id']").select2("val", {{ $assetdata->store_id }});
			  });
		...
		function createstore(){
      		if($('input[name="main_store_name"]').val()==''){
      			alert('Enter store name');
      			return false;
      		}
      	  ...
      	  $.ajax({
			  type: "POST",
			  url: "{{ URL::action('StoresController@createstore') }}",
			  data: { store_name:$('input[name="main_store_name"]').val(),store_description:$('input[name="main_store_description"]').val(),location_id:$("select[name='location']").select2("val") }
			})
			  .done(function( msg ) {
			  	$("select[name='store_id']").append("<option value='"+msg['store_id']+"'>"+$('input[name="main_store_name"]').val()+"</option>");
			  	$("select[name='store_id']").select2("val", msg['store_id']);
			  	$('#createstore button.close').click();
			  });
		}
